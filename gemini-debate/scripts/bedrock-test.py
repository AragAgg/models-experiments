...
MODEL_A = "anthropic.claude-3-sonnet-20240229-v1:0"
MODEL_B = "anthropic.claude-3-sonnet-20240229-v1:0"
MAX_TURNS = 10
RETRY_ATTEMPTS = 3
RETRY_DELAY = 2
...
def run():
    ...
    for turn in range(MAX_TURNS):
        ...
        msg_a = call_api(client, MODEL_A, prompt_a)
        ...
        msg_b = call_api(client, MODEL_B, prompt_b)
